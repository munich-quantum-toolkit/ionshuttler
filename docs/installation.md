...
MQT IonShuttler is a Python package available on [PyPI](https://pypi.org/project/mqt.ionshuttler/).
...
To use the MQT IonShuttler Python package in your project, add it as a dependency in your {code}`pyproject.toml` or {code}`setup.py`.
...
Set up a reproducible development environment for MQT IonShuttler.
...
1.  Get the code:
    ...
    If you do not have write access to the [munich-quantum-toolkit/ionshuttler](https://github.com/munich-quantum-toolkit/ionshuttler) repository, fork the repository on GitHub (see <https://docs.github.com/en/get-started/quickstart/fork-a-repo>) and clone your fork locally.
    ...
    If you have write access to the [munich-quantum-toolkit/ionshuttler](https://github.com/munich-quantum-toolkit/ionshuttler) repository, clone the repository locally.
