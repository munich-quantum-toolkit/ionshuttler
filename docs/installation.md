...
MQT IonShuttler is a Python package available on
[PyPI](https://pypi.org/project/mqt.ionshuttler/). It can be installed on all
...
```console
python -m pip install mqt.ionshuttler
```
...
```console
python -c "import mqt.ionshuttler; print(mqt.ionshuttler.__version__)"
```
...
To use the MQT IonShuttler Python package in your project, add it as a dependency
...
Set up a reproducible development environment for MQT IonShuttler. This is the
...
1. Get the code: <!-- rumdl-disable-line MD013 -->
   ...
   [munich-quantum-toolkit/ionshuttler](https://github.com/munich-quantum-toolkit/ionshuttler)
